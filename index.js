...
/////////////////
const BotName = 'Uaze BOT'; 
const instagram = 'https://instagram.com/uazegaming_yt'; 
const whatsapp = 'wa.me/6281287170035'; 
const kapanbotaktif = '7:00 WIB - 19:00 WIB'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@uazegaming_yt')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@uazegaming_yt`)
})
